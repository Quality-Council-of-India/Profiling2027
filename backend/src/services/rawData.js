    ...
    case "peer_evaluations": {
      ...
      return {
        ...
        rows: result.rows.map((r) => ({
          ...
          ownership_discipline: r.ownership_discipline,
          team_spirit: r.team_spirit,
          communication_clarity: r.communication_clarity,
          domain_knowledge: r.domain_knowledge,
          timeliness_throughput: r.timeliness_throughput,
          work_quality: r.work_quality,
          problem_solving_initiative: r.problem_solving_initiative,
