 ...
 * self-rating is honest. Callers must separately check that the viewer IS
 * the target (an Admin/Lead/Anchor looking at someone else's scores for
 * oversight isn't part of this concern). Closed weeks are always shown in
 * full — once a week closes there's nothing left to game.
 */
