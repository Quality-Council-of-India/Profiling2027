...
export const PARAM_FIELDS = [
  { key: "sincerity", label: "Sincerity", desc: "Commitment to responsibility, discipline and ownership" },
  { key: "team_spirit", label: "Team Spirit", desc: "Ability to work as part of a team through open communication" },
  { key: "knowledge", label: "Knowledge", desc: "Ability to grasp and apply concepts effectively" },
  { key: "quantity", label: "Quantity", desc: "Consistency in meeting deadlines and achieving set targets" },
  { key: "quality", label: "Quality", desc: "Competence and ability to meet expected standards" },
];

export const PARAM_LABELS = ["Sincerity", "Team Spirit", "Knowledge", "Quantity", "Quality"];
