...
export default function SAPAGauge({ sapa }) {
  if (sapa === null || sapa === undefined) {
    return <p className="text-sm text-gray-400">Not enough data yet (need both self and peer scores).</p>;
  }
  const v = Number(sapa);
  ...
  return (
    <div>
      ...
      <div className="relative h-3 rounded-full bg-gradient-to-r from-blue-200 via-green-300 to-red-300">
        ...
        />
        <div className="absolute top-1/2 -translate-y-1/2 left-1/2 w-0.5 h-4 bg-gray-400" />
      </div>
